...
public class ActorConversionTest {
	...
	public void minimal() {
		...
		TestUtils.assertLangString(contact.getName(), "Actor");
		...
		TestUtils.assertNull(info.email, info.telefax, info.telephone, info.wwwAddress, info.description,
	...
	public void complete() {
		...
		DataSetInfo info = contact.contactInfo.dataSetInfo;
		TestUtils.assertLangString(info.description, "This is a complete actor");
		...
		TestUtils.assertLangString(info.contactAddress, "Müllerstraße 135, 11111 Berlin");
